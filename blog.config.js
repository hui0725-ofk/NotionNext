...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '辉辉', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '无需登入，没有广告，随意下载', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://huihui0725.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ACG, huihui', // 网站关键词 英文逗号隔开
